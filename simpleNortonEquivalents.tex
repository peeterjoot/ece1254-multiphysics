...
\imageFigure{../figures/ece1254-multiphysics/first-voltage-source-configuration.pdf}{First voltage source configuration.}{fig:nortonEquivalent:nortonEquivalentFig1}{0.3}
...
\imageFigure{../figures/ece1254-multiphysics/second-voltage-source-configuration.pdf}{Second voltage source configuration.}{fig:nortonEquivalent:nortonEquivalentFig2}{0.3}
...
\imageFigure{../figures/ece1254-multiphysics/current-source-configuration.pdf}{Current source configuration.}{fig:nortonEquivalent:nortonEquivalentFig3}{0.3}
