...
x + 10^{-6} e^{80x} = 5.
\end{equation}
\imageFigure{../figures/ece1254-multiphysics/ps2bFig1}{Circuit.}{fig:ps2b:ps2bFig1}{0.3}
...
%
\mathImageFigure{../figures/ece1254-multiphysics/ps2bPlotDiodeFig2}{Diode plot.}{fig:ps2bPlotDiode:ps2bPlotDiodeFig2}{0.3}{plotDiode.nb}
%
A call to
%
